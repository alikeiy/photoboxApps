...
public abstract class EGLBase {
    ...
    private static class ContextShim implements IContext {
        ...
        ContextShim(com.serenegiant.egl.EGLBase.IContext context) { this.mContext = context; }
        @Override public Object getContext() { return mContext; }
    }

    protected final com.serenegiant.egl.EGLBase mDelegate;

    protected EGLBase(com.serenegiant.egl.EGLBase delegate) { this.mDelegate = delegate; }
    ...
    public static EGLBase createFrom(@Nullable final IContext sharedContext, final boolean withDepthBuffer, final boolean isRecordable) {
        com.serenegiant.egl.EGLBase.IContext shared = (sharedContext instanceof ContextShim)
            ? (com.serenegiant.egl.EGLBase.IContext) sharedContext.getContext() : null;
